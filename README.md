...
* [Berkeley Ray RLLib](https://github.com/ray-project/ray) ⭐ 43,912 | 🐛 3,611 | 🌐 Python | 📅 2026-09-23 - An open-source library for reinforcement learning that offers both high scalability and a unified API for a variety of applications.
* [Unity ML-Agents Toolkit](https://github.com/Unity-Technologies/ml-agents) ⭐ 19,700 | 🐛 21 | 🌐 C# | 📅 2026-09-17 - Unity Machine Learning Agents Toolkit.
...
* [Tianshou](https://github.com/thu-ml/tianshou/) ⭐ 10,990 | 🐛 142 | 🌐 Python | 📅 2026-04-03 - Tianshou (天授) is a reinforcement learning platform based on pure PyTorch.
...
* [DeepMind OpenSpiel](https://github.com/deepmind/open_spiel) ⭐ 5,501 | 🐛 63 | 🌐 C++ | 📅 2026-08-31 - A collection of environments and algorithms for research in general reinforcement learning and search/planning in games.
...
* [AgileRL](https://github.com/AgileRL/AgileRL) ⭐ 951 | 🐛 6 | 🌐 Python | 📅 2026-09-23 - A Deep Reinforcement Learning library focused on improving development by introducing RLOps - MLOps for reinforcement learning.
* [MushroomRL](https://github.com/MushroomRL/mushroom-rl) ⭐ 943 | 🐛 3 | 🌐 Python | 📅 2026-09-21 - Python library for Reinforcement Learning experiments.
...
* [DeepMind bsuite](https://github.com/deepmind/bsuite/tree/master/bsuite) ⭐ 1,559 | 🐛 20 | 🌐 Python | 📅 2026-09-09
...
* [Unity ML-Agents Toolkit](https://github.com/Unity-Technologies/ml-agents) ⭐ 19,700 | 🐛 21 | 🌐 C# | 📅 2026-09-17 - Unity Machine Learning Agents Toolkit.
* [Microsoft AirSim](https://github.com/Microsoft/AirSim) ⭐ 18,510 | 🐛 781 | 🌐 C++ | 📅 2026-09-15 - Open source simulator for autonomous vehicles built on Unreal Engine / Unity, from Microsoft AI & Research.
...
* [Carla](https://github.com/carla-simulator/carla) ⭐ 14,423 | 🐛 1,197 | 🌐 C++ | 📅 2026-09-23 - Open-source simulator for autonomous driving research.
* [DeepMind PySC2](https://github.com/deepmind/pysc2) ⭐ 8,313 | 🐛 64 | 🌐 Python | 📅 2024-07-23 - StarCraft II Learning Environment.
* [DeepMind Lab](https://github.com/deepmind/lab) ⭐ 7,381 | 🐛 67 | 🌐 C | 📅 2023-01-04 - A customisable 3D platform for agent-based AI research.
* [DeepMind DM Control](https://github.com/deepmind/dm_control) ⭐ 4,702 | 🐛 130 | 🌐 Python | 📅 2026-09-22 - The DeepMind Control Suite and Package.
...
* [Facebook Habitat](https://github.com/facebookresearch/habitat-api) ⭐ 3,142 | 🐛 390 | 🌐 Python | 📅 2026-05-07 - A modular high-level library to train embodied AI agents across a variety of tasks, environments, and simulators.
...
* [Meta-World](https://github.com/rlworkgroup/metaworld) ⭐ 1,886 | 🐛 17 | 🌐 Python | 📅 2026-09-12 - An open source robotics benchmark for meta- and multi-task reinforcement learning.
...
* [AI2-THOR](https://github.com/allenai/ai2thor) ⭐ 1,803 | 🐛 280 | 🌐 C# | 📅 2025-11-04 - A near photo-realistic interactable framework for AI agents.
...
* [DeepMind AndroidEnv](https://github.com/deepmind/android_env) ⭐ 1,244 | 🐛 13 | 🌐 Python | 📅 2026-09-23 - A library for doing RL research on Android devices.
* [Facebook House3D](https://github.com/facebookresearch/House3D) ⚠️ Archived - A Rich and Realistic 3D Environment.
* [OpenAI Procgen Benchmark](https://github.com/openai/procgen) ⭐ 1,191 | 🐛 20 | 🌐 C++ | 📅 2026-03-27 - Procedurally Generated Game-Like Gym Environments.
...
* [OpenAI Spinning Up](https://github.com/openai/spinningup) ⭐ 11,971 | 🐛 255 | 🌐 Python | 📅 2024-08-05
...
* [higgsfield/RL-Adventure-2](https://github.com/higgsfield/RL-Adventure-2) ⭐ 5,651 | 🐛 15 | 🌐 Jupyter Notebook | 📅 2026-09-14
