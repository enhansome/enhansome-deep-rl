...
* [Berkeley Ray RLLib](https://github.com/ray-project/ray) ⭐ 43,685 | 🐛 3,539 | 🌐 Python | 📅 2026-09-02 - An open-source library for reinforcement learning that offers both high scalability and a unified API for a variety of applications.
...
* [OpenAI Baselines](https://github.com/openai/baselines) ⭐ 16,761 | 🐛 502 | 🌐 Python | 📅 2024-08-01 - High-quality implementations of reinforcement learning algorithms.
...
* [Google Dopamine](https://github.com/google/dopamine) ⭐ 10,908 | 🐛 111 | 🌐 Jupyter Notebook | 📅 2026-03-24 - A research framework for fast prototyping of reinforcement learning algorithms.
* [DeepMind OpenSpiel](https://github.com/deepmind/open_spiel) ⭐ 5,452 | 🐛 51 | 🌐 C++ | 📅 2026-08-31 - A collection of environments and algorithms for research in general reinforcement learning and search/planning in games.
...
* [DI-engine](https://github.com/opendilab/DI-engine) ⭐ 3,642 | 🐛 26 | 🌐 Python | 📅 2025-12-07 - A generalized decision intelligence engine. It supports various Deep RL algorithms.
...
* [Berkeley Softlearning](https://github.com/rail-berkeley/softlearning) ⭐ 1,440 | 🐛 53 | 🌐 Python | 📅 2023-11-29 - A reinforcement learning framework for training maximum entropy policies in continuous domains.
...
* [RLtools](https://github.com/rl-tools/rl-tools) ⭐ 1,032 | 🐛 20 | 🌐 C++ | 📅 2026-07-04 - The fastest deep reinforcement learning library for continuous control, implemented in pure, dependency-free C++ (Python bindings available as well).
* [AgileRL](https://github.com/AgileRL/AgileRL) ⭐ 948 | 🐛 13 | 🌐 Python | 📅 2026-09-02 - A Deep Reinforcement Learning library focused on improving development by introducing RLOps - MLOps for reinforcement learning.
* [MushroomRL](https://github.com/MushroomRL/mushroom-rl) ⭐ 944 | 🐛 4 | 🌐 Python | 📅 2026-09-02 - Python library for Reinforcement Learning experiments.
...
* [OpenAI Baselines](https://github.com/openai/baselines#benchmarks) ⭐ 16,761 | 🐛 502 | 🌐 Python | 📅 2024-08-01
...
* [Unity ML-Agents Toolkit](https://github.com/Unity-Technologies/ml-agents) ⭐ 19,653 | 🐛 21 | 🌐 C# | 📅 2026-08-25 - Unity Machine Learning Agents Toolkit.
* [Microsoft AirSim](https://github.com/Microsoft/AirSim) ⭐ 18,433 | 🐛 780 | 🌐 C++ | 📅 2026-06-30 - Open source simulator for autonomous vehicles built on Unreal Engine / Unity, from Microsoft AI & Research.
...
* [Carla](https://github.com/carla-simulator/carla) ⭐ 14,352 | 🐛 1,191 | 🌐 C++ | 📅 2026-09-02 - Open-source simulator for autonomous driving research.
...
* [DouZero](https://github.com/kwai/DouZero/) ⭐ 4,659 | 🐛 35 | 🌐 Python | 📅 2024-06-26 - A research platform for reinforcement learning in DouDizhu (Chinese poker).
...
* [RLCard](https://github.com/datamllab/rlcard/) ⭐ 3,541 | 🐛 80 | 🌐 Python | 📅 2024-06-26 - A research platform for reinforcement learning in card games.
* [Facebook Habitat](https://github.com/facebookresearch/habitat-api) ⭐ 3,117 | 🐛 388 | 🌐 Python | 📅 2026-05-07 - A modular high-level library to train embodied AI agents across a variety of tasks, environments, and simulators.
...
* [dennybritz/reinforcement-learning](https://github.com/dennybritz/reinforcement-learning) ⭐ 22,122 | 🐛 117 | 🌐 Jupyter Notebook | 📅 2023-07-13
* [OpenAI Spinning Up](https://github.com/openai/spinningup) ⭐ 11,930 | 🐛 253 | 🌐 Python | 📅 2024-08-05
...
* [The Hugging Face Deep Reinforcement Learning Class 🤗](https://github.com/huggingface/deep-rl-class#the-hugging-face-deep-reinforcement-learning-class-) ⭐ 5,006 | 🐛 147 | 🌐 MDX | 📅 2026-05-26
* [higgsfield/RL-Adventure-2](https://github.com/higgsfield/RL-Adventure-2) ⭐ 4,129 | 🐛 9 | 🌐 Jupyter Notebook | 📅 2024-05-25
