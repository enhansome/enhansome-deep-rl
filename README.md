...
* [Berkeley Ray RLLib](https://github.com/ray-project/ray) ⭐ 43,812 | 🐛 3,611 | 🌐 Python | 📅 2026-09-15 - An open-source library for reinforcement learning that offers both high scalability and a unified API for a variety of applications.
* [Unity ML-Agents Toolkit](https://github.com/Unity-Technologies/ml-agents) ⭐ 19,675 | 🐛 21 | 🌐 C# | 📅 2026-09-02 - Unity Machine Learning Agents Toolkit.
...
* [Tianshou](https://github.com/thu-ml/tianshou/) ⭐ 10,974 | 🐛 142 | 🌐 Python | 📅 2026-04-03 - Tianshou (天授) is a reinforcement learning platform based on pure PyTorch.
* [Google Dopamine](https://github.com/google/dopamine) ⭐ 10,915 | 🐛 111 | 🌐 Jupyter Notebook | 📅 2026-03-24 - A research framework for fast prototyping of reinforcement learning algorithms.
* [DeepMind OpenSpiel](https://github.com/deepmind/open_spiel) ⭐ 5,486 | 🐛 57 | 🌐 C++ | 📅 2026-08-31 - A collection of environments and algorithms for research in general reinforcement learning and search/planning in games.
...
* [DeepMind Acme](https://github.com/deepmind/acme) ⭐ 4,062 | 🐛 102 | 🌐 Python | 📅 2026-09-11 - A research framework for reinforcement learning.
...
* [Facebook ReAgent](https://github.com/facebookresearch/ReAgent) ⭐ 3,715 | 🐛 85 | 🌐 Python | 📅 2026-09-01 - A platform for Reasoning systems (Reinforcement Learning, Contextual Bandits, etc.)
...
* [TensorForce](https://github.com/tensorforce/tensorforce) ⭐ 3,305 | 🐛 45 | 🌐 Python | 📅 2026-09-02 - A TensorFlow library for applied reinforcement learning.
...
* [skrl](https://github.com/Toni-SM/skrl) ⭐ 1,097 | 🐛 31 | 🌐 Python | 📅 2026-09-14 - Modular reinforcement learning library (on PyTorch and JAX) with support for NVIDIA Isaac Gym, Omniverse Isaac Gym and Isaac Lab.
* [RLtools](https://github.com/rl-tools/rl-tools) ⭐ 1,035 | 🐛 20 | 🌐 C++ | 📅 2026-09-10 - The fastest deep reinforcement learning library for continuous control, implemented in pure, dependency-free C++ (Python bindings available as well).
* [AgileRL](https://github.com/AgileRL/AgileRL) ⭐ 951 | 🐛 7 | 🌐 Python | 📅 2026-09-15 - A Deep Reinforcement Learning library focused on improving development by introducing RLOps - MLOps for reinforcement learning.
* [MushroomRL](https://github.com/MushroomRL/mushroom-rl) ⭐ 944 | 🐛 3 | 🌐 Python | 📅 2026-09-14 - Python library for Reinforcement Learning experiments.
...
* [DeepMind bsuite](https://github.com/deepmind/bsuite/tree/master/bsuite) ⭐ 1,558 | 🐛 19 | 🌐 Python | 📅 2026-09-09
...
* [Unity ML-Agents Toolkit](https://github.com/Unity-Technologies/ml-agents) ⭐ 19,675 | 🐛 21 | 🌐 C# | 📅 2026-09-02 - Unity Machine Learning Agents Toolkit.
* [Microsoft AirSim](https://github.com/Microsoft/AirSim) ⭐ 18,480 | 🐛 780 | 🌐 C++ | 📅 2026-06-30 - Open source simulator for autonomous vehicles built on Unreal Engine / Unity, from Microsoft AI & Research.
* [DeepMind RL Unplugged](https://github.com/deepmind/deepmind-research/tree/master/rl_unplugged) ⭐ 15,198 | 🐛 359 | 🌐 Jupyter Notebook | 📅 2026-06-17 - Benchmarks for Offline Reinforcement Learning.
* [Carla](https://github.com/carla-simulator/carla) ⭐ 14,402 | 🐛 1,201 | 🌐 C++ | 📅 2026-09-15 - Open-source simulator for autonomous driving research.
...
* [DeepMind DM Control](https://github.com/deepmind/dm_control) ⭐ 4,693 | 🐛 129 | 🌐 Python | 📅 2026-09-09 - The DeepMind Control Suite and Package.
...
* [Facebook Habitat](https://github.com/facebookresearch/habitat-api) ⭐ 3,133 | 🐛 390 | 🌐 Python | 📅 2026-05-07 - A modular high-level library to train embodied AI agents across a variety of tasks, environments, and simulators.
...
* [VizDoom](https://github.com/mwydmuch/ViZDoom) ⭐ 2,073 | 🐛 38 | 🌐 C++ | 📅 2026-09-13 - Doom-based AI Research Platform for Reinforcement Learning from Raw Visual Information.
* [Meta-World](https://github.com/rlworkgroup/metaworld) ⭐ 1,881 | 🐛 16 | 🌐 Python | 📅 2026-09-12 - An open source robotics benchmark for meta- and multi-task reinforcement learning.
...
* [RLBench](https://github.com/stepjam/RLBench) ⭐ 1,818 | 🐛 93 | 🌐 Python | 📅 2025-01-25 - A large-scale benchmark and learning environment.
...
* [Microsoft TextWorld](https://github.com/microsoft/TextWorld) ⭐ 1,445 | 🐛 21 | 🌐 Jupyter Notebook | 📅 2026-09-01 - A text-based game generator and extensible sandbox learning environment for training and testing reinforcement learning (RL) agents.
* [Personae](https://github.com/Ceruleanacg/Personae) ⭐ 1,409 | 🐛 9 | 🌐 Python | 📅 2018-11-29 - RL & SL Methods and Envs For Quantitative Trading.
* [DeepMind AndroidEnv](https://github.com/deepmind/android_env) ⭐ 1,242 | 🐛 12 | 🌐 Python | 📅 2026-09-09 - A library for doing RL research on Android devices.
* [Facebook House3D](https://github.com/facebookresearch/House3D) ⚠️ Archived - A Rich and Realistic 3D Environment.
* [OpenAI Procgen Benchmark](https://github.com/openai/procgen) ⭐ 1,189 | 🐛 20 | 🌐 C++ | 📅 2026-03-27 - Procedurally Generated Game-Like Gym Environments.
...
* [MineRL](https://github.com/minerllabs/minerl) ⭐ 976 | 🐛 241 | 🌐 Java | 📅 2025-01-22 - MineRL Competition for Sample Efficient Reinforcement Learning.
...
* [OpenAI Spinning Up](https://github.com/openai/spinningup) ⭐ 11,951 | 🐛 253 | 🌐 Python | 📅 2024-08-05
...
* [The Hugging Face Deep Reinforcement Learning Class 🤗](https://github.com/huggingface/deep-rl-class#the-hugging-face-deep-reinforcement-learning-class-) ⭐ 5,014 | 🐛 147 | 🌐 MDX | 📅 2026-05-26
* [higgsfield/RL-Adventure-2](https://github.com/higgsfield/RL-Adventure-2) ⭐ 4,206 | 🐛 10 | 🌐 Jupyter Notebook | 📅 2026-09-14
