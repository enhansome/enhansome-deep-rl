...
* [Berkeley Ray RLLib](https://github.com/ray-project/ray) ⭐ 43,594 | 🐛 3,522 | 🌐 Python | 📅 2026-08-24 - An open-source library for reinforcement learning that offers both high scalability and a unified API for a variety of applications.
* [Unity ML-Agents Toolkit](https://github.com/Unity-Technologies/ml-agents) ⭐ 19,643 | 🐛 20 | 🌐 C# | 📅 2026-08-14 - Unity Machine Learning Agents Toolkit.
...
* [Tianshou](https://github.com/thu-ml/tianshou/) ⭐ 10,940 | 🐛 137 | 🌐 Python | 📅 2026-04-03 - Tianshou (天授) is a reinforcement learning platform based on pure PyTorch.
...
* [DeepMind OpenSpiel](https://github.com/deepmind/open_spiel) ⭐ 5,431 | 🐛 50 | 🌐 C++ | 📅 2026-08-12 - A collection of environments and algorithms for research in general reinforcement learning and search/planning in games.
...
* [DeepMind Acme](https://github.com/deepmind/acme) ⭐ 4,047 | 🐛 100 | 🌐 Python | 📅 2026-08-01 - A research framework for reinforcement learning.
...
* [Facebook ReAgent](https://github.com/facebookresearch/ReAgent) ⭐ 3,712 | 🐛 85 | 🌐 Python | 📅 2026-08-20 - A platform for Reasoning systems (Reinforcement Learning, Contextual Bandits, etc.)
...
* [DeepRL](https://github.com/ShangtongZhang/DeepRL) ⭐ 3,447 | 🐛 9 | 🌐 Python | 📅 2024-04-16 - Modularized Implementation of Deep RL Algorithms in PyTorch.
...
* [RLtools](https://github.com/rl-tools/rl-tools) ⭐ 1,025 | 🐛 20 | 🌐 C++ | 📅 2026-07-04 - The fastest deep reinforcement learning library for continuous control, implemented in pure, dependency-free C++ (Python bindings available as well).
* [AgileRL](https://github.com/AgileRL/AgileRL) ⭐ 946 | 🐛 13 | 🌐 Python | 📅 2026-08-24 - A Deep Reinforcement Learning library focused on improving development by introducing RLOps - MLOps for reinforcement learning.
...
* [DeepMind RL Unplugged](https://github.com/deepmind/deepmind-research/tree/master/rl_unplugged) ⭐ 15,165 | 🐛 358 | 🌐 Jupyter Notebook | 📅 2026-06-17 - Benchmarks for Offline Reinforcement Learning.
* [Carla](https://github.com/carla-simulator/carla) ⭐ 14,317 | 🐛 1,193 | 🌐 C++ | 📅 2026-08-24 - Open-source simulator for autonomous driving research.
...
* [DeepMind DM Control](https://github.com/deepmind/dm_control) ⭐ 4,670 | 🐛 126 | 🌐 Python | 📅 2026-08-20 - The DeepMind Control Suite and Package.
...
* [VizDoom](https://github.com/mwydmuch/ViZDoom) ⭐ 2,062 | 🐛 39 | 🌐 C++ | 📅 2026-08-21 - Doom-based AI Research Platform for Reinforcement Learning from Raw Visual Information.
* [Meta-World](https://github.com/rlworkgroup/metaworld) ⭐ 1,869 | 🐛 13 | 🌐 Python | 📅 2026-08-10 - An open source robotics benchmark for meta- and multi-task reinforcement learning.
...
* [ma-gym](https://github.com/koulanurag/ma-gym) ⭐ 634 | 🐛 0 | 🌐 Python | 📅 2024-07-07 - A collection of multi agent environments based on OpenAI gym.
...
* [dennybritz/reinforcement-learning](https://github.com/dennybritz/reinforcement-learning) ⭐ 22,113 | 🐛 117 | 🌐 Jupyter Notebook | 📅 2023-07-13
* [OpenAI Spinning Up](https://github.com/openai/spinningup) ⭐ 11,911 | 🐛 253 | 🌐 Python | 📅 2024-08-05
...
* [The Hugging Face Deep Reinforcement Learning Class 🤗](https://github.com/huggingface/deep-rl-class#the-hugging-face-deep-reinforcement-learning-class-) ⭐ 4,993 | 🐛 145 | 🌐 MDX | 📅 2026-05-26
* [higgsfield/RL-Adventure-2](https://github.com/higgsfield/RL-Adventure-2) ⭐ 4,097 | 🐛 9 | 🌐 Jupyter Notebook | 📅 2024-05-25
