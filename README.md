...
* [Berkeley Ray RLLib](https://github.com/ray-project/ray) ⭐ 43,777 | 🐛 3,592 | 🌐 Python | 📅 2026-09-11 - An open-source library for reinforcement learning that offers both high scalability and a unified API for a variety of applications.
* [Unity ML-Agents Toolkit](https://github.com/Unity-Technologies/ml-agents) ⭐ 19,671 | 🐛 21 | 🌐 C# | 📅 2026-09-02 - Unity Machine Learning Agents Toolkit.
...
* [Tianshou](https://github.com/thu-ml/tianshou/) ⭐ 10,969 | 🐛 141 | 🌐 Python | 📅 2026-04-03 - Tianshou (天授) is a reinforcement learning platform based on pure PyTorch.
* [Google Dopamine](https://github.com/google/dopamine) ⭐ 10,911 | 🐛 111 | 🌐 Jupyter Notebook | 📅 2026-03-24 - A research framework for fast prototyping of reinforcement learning algorithms.
* [DeepMind OpenSpiel](https://github.com/deepmind/open_spiel) ⭐ 5,476 | 🐛 52 | 🌐 C++ | 📅 2026-08-31 - A collection of environments and algorithms for research in general reinforcement learning and search/planning in games.
...
* [DeepMind Acme](https://github.com/deepmind/acme) ⭐ 4,058 | 🐛 100 | 🌐 Python | 📅 2026-09-11 - A research framework for reinforcement learning.
...
* [Catalyst](https://github.com/catalyst-team/catalyst) ⭐ 3,383 | 🐛 5 | 🌐 Python | 📅 2026-07-08 - Accelerated DL & RL.
...
* [RLkit](https://github.com/vitchyr/rlkit) ⭐ 2,933 | 🐛 40 | 🌐 Python | 📅 2024-06-17 - Reinforcement learning framework and algorithms implemented in PyTorch.
...
* [skrl](https://github.com/Toni-SM/skrl) ⭐ 1,097 | 🐛 27 | 🌐 Python | 📅 2026-09-10 - Modular reinforcement learning library (on PyTorch and JAX) with support for NVIDIA Isaac Gym, Omniverse Isaac Gym and Isaac Lab.
* [RLtools](https://github.com/rl-tools/rl-tools) ⭐ 1,034 | 🐛 20 | 🌐 C++ | 📅 2026-09-10 - The fastest deep reinforcement learning library for continuous control, implemented in pure, dependency-free C++ (Python bindings available as well).
* [AgileRL](https://github.com/AgileRL/AgileRL) ⭐ 951 | 🐛 7 | 🌐 Python | 📅 2026-09-11 - A Deep Reinforcement Learning library focused on improving development by introducing RLOps - MLOps for reinforcement learning.
* [MushroomRL](https://github.com/MushroomRL/mushroom-rl) ⭐ 944 | 🐛 3 | 🌐 Python | 📅 2026-09-11 - Python library for Reinforcement Learning experiments.
...
* [DeepMind bsuite](https://github.com/deepmind/bsuite/tree/master/bsuite) ⭐ 1,556 | 🐛 19 | 🌐 Python | 📅 2026-09-09
...
* [Unity ML-Agents Toolkit](https://github.com/Unity-Technologies/ml-agents) ⭐ 19,671 | 🐛 21 | 🌐 C# | 📅 2026-09-02 - Unity Machine Learning Agents Toolkit.
* [Microsoft AirSim](https://github.com/Microsoft/AirSim) ⭐ 18,469 | 🐛 780 | 🌐 C++ | 📅 2026-06-30 - Open source simulator for autonomous vehicles built on Unreal Engine / Unity, from Microsoft AI & Research.
* [DeepMind RL Unplugged](https://github.com/deepmind/deepmind-research/tree/master/rl_unplugged) ⭐ 15,191 | 🐛 358 | 🌐 Jupyter Notebook | 📅 2026-06-17 - Benchmarks for Offline Reinforcement Learning.
* [Carla](https://github.com/carla-simulator/carla) ⭐ 14,388 | 🐛 1,197 | 🌐 C++ | 📅 2026-09-11 - Open-source simulator for autonomous driving research.
* [DeepMind PySC2](https://github.com/deepmind/pysc2) ⭐ 8,308 | 🐛 64 | 🌐 Python | 📅 2024-07-23 - StarCraft II Learning Environment.
* [DeepMind Lab](https://github.com/deepmind/lab) ⭐ 7,376 | 🐛 66 | 🌐 C | 📅 2023-01-04 - A customisable 3D platform for agent-based AI research.
* [DeepMind DM Control](https://github.com/deepmind/dm_control) ⭐ 4,689 | 🐛 128 | 🌐 Python | 📅 2026-09-09 - The DeepMind Control Suite and Package.
* [DouZero](https://github.com/kwai/DouZero/) ⭐ 4,664 | 🐛 35 | 🌐 Python | 📅 2024-06-26 - A research platform for reinforcement learning in DouDizhu (Chinese poker).
...
* [RLCard](https://github.com/datamllab/rlcard/) ⭐ 3,546 | 🐛 80 | 🌐 Python | 📅 2024-06-26 - A research platform for reinforcement learning in card games.
* [Facebook Habitat](https://github.com/facebookresearch/habitat-api) ⭐ 3,127 | 🐛 390 | 🌐 Python | 📅 2026-05-07 - A modular high-level library to train embodied AI agents across a variety of tasks, environments, and simulators.
...
* [VizDoom](https://github.com/mwydmuch/ViZDoom) ⭐ 2,067 | 🐛 40 | 🌐 C++ | 📅 2026-09-10 - Doom-based AI Research Platform for Reinforcement Learning from Raw Visual Information.
* [Meta-World](https://github.com/rlworkgroup/metaworld) ⭐ 1,880 | 🐛 16 | 🌐 Python | 📅 2026-08-10 - An open source robotics benchmark for meta- and multi-task reinforcement learning.
...
* [AI2-THOR](https://github.com/allenai/ai2thor) ⭐ 1,792 | 🐛 280 | 🌐 C# | 📅 2025-11-04 - A near photo-realistic interactable framework for AI agents.
* [OpenAI Neural MMO](https://github.com/openai/neural-mmo) ⚠️ Archived - A Massively Multiagent Game Environment.
* [Microsoft TextWorld](https://github.com/microsoft/TextWorld) ⭐ 1,446 | 🐛 21 | 🌐 Jupyter Notebook | 📅 2026-09-01 - A text-based game generator and extensible sandbox learning environment for training and testing reinforcement learning (RL) agents.
* [Personae](https://github.com/Ceruleanacg/Personae) ⭐ 1,409 | 🐛 9 | 🌐 Python | 📅 2018-11-29 - RL & SL Methods and Envs For Quantitative Trading.
* [DeepMind AndroidEnv](https://github.com/deepmind/android_env) ⭐ 1,241 | 🐛 12 | 🌐 Python | 📅 2026-09-09 - A library for doing RL research on Android devices.
* [Facebook House3D](https://github.com/facebookresearch/House3D) ⚠️ Archived - A Rich and Realistic 3D Environment.
* [OpenAI Procgen Benchmark](https://github.com/openai/procgen) ⭐ 1,188 | 🐛 20 | 🌐 C++ | 📅 2026-03-27 - Procedurally Generated Game-Like Gym Environments.
...
* [Microsoft Jericho](https://github.com/microsoft/jericho) ⭐ 337 | 🐛 7 | 🌐 C | 📅 2026-09-09 - A learning environment for man-made Interactive Fiction games.
...
* [dennybritz/reinforcement-learning](https://github.com/dennybritz/reinforcement-learning) ⭐ 22,132 | 🐛 117 | 🌐 Jupyter Notebook | 📅 2023-07-13
* [OpenAI Spinning Up](https://github.com/openai/spinningup) ⭐ 11,946 | 🐛 253 | 🌐 Python | 📅 2024-08-05
...
* [The Hugging Face Deep Reinforcement Learning Class 🤗](https://github.com/huggingface/deep-rl-class#the-hugging-face-deep-reinforcement-learning-class-) ⭐ 5,012 | 🐛 147 | 🌐 MDX | 📅 2026-05-26
* [higgsfield/RL-Adventure-2](https://github.com/higgsfield/RL-Adventure-2) ⭐ 4,180 | 🐛 9 | 🌐 Jupyter Notebook | 📅 2024-05-25
