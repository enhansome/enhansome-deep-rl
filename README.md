...
* [Berkeley Ray RLLib](https://github.com/ray-project/ray) ⭐ 43,853 | 🐛 3,591 | 🌐 Python | 📅 2026-09-17 - An open-source library for reinforcement learning that offers both high scalability and a unified API for a variety of applications.
* [Unity ML-Agents Toolkit](https://github.com/Unity-Technologies/ml-agents) ⭐ 19,685 | 🐛 21 | 🌐 C# | 📅 2026-09-17 - Unity Machine Learning Agents Toolkit.
...
* [Tianshou](https://github.com/thu-ml/tianshou/) ⭐ 10,980 | 🐛 142 | 🌐 Python | 📅 2026-04-03 - Tianshou (天授) is a reinforcement learning platform based on pure PyTorch.
...
* [DeepMind OpenSpiel](https://github.com/deepmind/open_spiel) ⭐ 5,490 | 🐛 58 | 🌐 C++ | 📅 2026-08-31 - A collection of environments and algorithms for research in general reinforcement learning and search/planning in games.
...
* [DeepMind Acme](https://github.com/deepmind/acme) ⭐ 4,064 | 🐛 102 | 🌐 Python | 📅 2026-09-16 - A research framework for reinforcement learning.
...
* [RLkit](https://github.com/vitchyr/rlkit) ⭐ 2,936 | 🐛 40 | 🌐 Python | 📅 2024-06-17 - Reinforcement learning framework and algorithms implemented in PyTorch.
...
* [skrl](https://github.com/Toni-SM/skrl) ⭐ 1,098 | 🐛 31 | 🌐 Python | 📅 2026-09-14 - Modular reinforcement learning library (on PyTorch and JAX) with support for NVIDIA Isaac Gym, Omniverse Isaac Gym and Isaac Lab.
...
* [AgileRL](https://github.com/AgileRL/AgileRL) ⭐ 950 | 🐛 7 | 🌐 Python | 📅 2026-09-17 - A Deep Reinforcement Learning library focused on improving development by introducing RLOps - MLOps for reinforcement learning.
* [MushroomRL](https://github.com/MushroomRL/mushroom-rl) ⭐ 944 | 🐛 3 | 🌐 Python | 📅 2026-09-17 - Python library for Reinforcement Learning experiments.
...
* [Unity ML-Agents Toolkit](https://github.com/Unity-Technologies/ml-agents) ⭐ 19,685 | 🐛 21 | 🌐 C# | 📅 2026-09-17 - Unity Machine Learning Agents Toolkit.
* [Microsoft AirSim](https://github.com/Microsoft/AirSim) ⭐ 18,490 | 🐛 780 | 🌐 C++ | 📅 2026-09-15 - Open source simulator for autonomous vehicles built on Unreal Engine / Unity, from Microsoft AI & Research.
* [DeepMind RL Unplugged](https://github.com/deepmind/deepmind-research/tree/master/rl_unplugged) ⭐ 15,201 | 🐛 359 | 🌐 Jupyter Notebook | 📅 2026-06-17 - Benchmarks for Offline Reinforcement Learning.
* [Carla](https://github.com/carla-simulator/carla) ⭐ 14,404 | 🐛 1,202 | 🌐 C++ | 📅 2026-09-17 - Open-source simulator for autonomous driving research.
...
* [RLCard](https://github.com/datamllab/rlcard/) ⭐ 3,548 | 🐛 80 | 🌐 Python | 📅 2024-06-26 - A research platform for reinforcement learning in card games.
* [Facebook Habitat](https://github.com/facebookresearch/habitat-api) ⭐ 3,134 | 🐛 390 | 🌐 Python | 📅 2026-05-07 - A modular high-level library to train embodied AI agents across a variety of tasks, environments, and simulators.
...
* [Meta-World](https://github.com/rlworkgroup/metaworld) ⭐ 1,882 | 🐛 16 | 🌐 Python | 📅 2026-09-12 - An open source robotics benchmark for meta- and multi-task reinforcement learning.
...
* [Microsoft TextWorld](https://github.com/microsoft/TextWorld) ⭐ 1,446 | 🐛 22 | 🌐 Jupyter Notebook | 📅 2026-09-01 - A text-based game generator and extensible sandbox learning environment for training and testing reinforcement learning (RL) agents.
...
* [PyGame Learning Environment](https://github.com/ntasfi/PyGame-Learning-Environment) ⭐ 1,067 | 🐛 22 | 🌐 Python | 📅 2022-01-19 - Reinforcement Learning Environment in Python.
...
* [RLGym](https://github.com/lucas-emery/rocket-league-gym) ⭐ 252 | 🐛 20 | 🌐 Python | 📅 2026-05-16 - A python API to treat the game Rocket League as an OpenAI Gym environment.
...
* [OpenAI Spinning Up](https://github.com/openai/spinningup) ⭐ 11,955 | 🐛 253 | 🌐 Python | 📅 2024-08-05
...
* [The Hugging Face Deep Reinforcement Learning Class 🤗](https://github.com/huggingface/deep-rl-class#the-hugging-face-deep-reinforcement-learning-class-) ⭐ 5,017 | 🐛 147 | 🌐 MDX | 📅 2026-09-17
* [higgsfield/RL-Adventure-2](https://github.com/higgsfield/RL-Adventure-2) ⭐ 4,222 | 🐛 10 | 🌐 Jupyter Notebook | 📅 2026-09-14
