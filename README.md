...
* [Berkeley Ray RLLib](https://github.com/ray-project/ray) ⭐ 43,506 | 🐛 3,486 | 🌐 Python | 📅 2026-08-13 - An open-source library for reinforcement learning that offers both high scalability and a unified API for a variety of applications.
* [Unity ML-Agents Toolkit](https://github.com/Unity-Technologies/ml-agents) ⭐ 19,627 | 🐛 17 | 🌐 C# | 📅 2026-08-12 - Unity Machine Learning Agents Toolkit.
...
* [Tianshou](https://github.com/thu-ml/tianshou/) ⭐ 10,925 | 🐛 137 | 🌐 Python | 📅 2026-04-03 - Tianshou (天授) is a reinforcement learning platform based on pure PyTorch.
* [Google Dopamine](https://github.com/google/dopamine) ⭐ 10,893 | 🐛 111 | 🌐 Jupyter Notebook | 📅 2026-03-24 - A research framework for fast prototyping of reinforcement learning algorithms.
* [DeepMind OpenSpiel](https://github.com/deepmind/open_spiel) ⭐ 5,409 | 🐛 48 | 🌐 C++ | 📅 2026-08-12 - A collection of environments and algorithms for research in general reinforcement learning and search/planning in games.
...
* [Google TF-Agents](https://github.com/tensorflow/agents) ⭐ 3,023 | 🐛 213 | 🌐 Python | 📅 2026-01-16 - TF-Agents is a library for Reinforcement Learning in TensorFlow.
...
* [skrl](https://github.com/Toni-SM/skrl) ⭐ 1,086 | 🐛 28 | 🌐 Python | 📅 2026-05-11 - Modular reinforcement learning library (on PyTorch and JAX) with support for NVIDIA Isaac Gym, Omniverse Isaac Gym and Isaac Lab.
...
* [AgileRL](https://github.com/AgileRL/AgileRL) ⭐ 943 | 🐛 10 | 🌐 Python | 📅 2026-08-13 - A Deep Reinforcement Learning library focused on improving development by introducing RLOps - MLOps for reinforcement learning.
...
* [Unity ML-Agents Toolkit](https://github.com/Unity-Technologies/ml-agents) ⭐ 19,627 | 🐛 17 | 🌐 C# | 📅 2026-08-12 - Unity Machine Learning Agents Toolkit.
* [Microsoft AirSim](https://github.com/Microsoft/AirSim) ⭐ 18,395 | 🐛 780 | 🌐 C++ | 📅 2026-06-30 - Open source simulator for autonomous vehicles built on Unreal Engine / Unity, from Microsoft AI & Research.
* [DeepMind RL Unplugged](https://github.com/deepmind/deepmind-research/tree/master/rl_unplugged) ⭐ 15,150 | 🐛 341 | 🌐 Jupyter Notebook | 📅 2026-06-17 - Benchmarks for Offline Reinforcement Learning.
* [Carla](https://github.com/carla-simulator/carla) ⭐ 14,290 | 🐛 1,188 | 🌐 C++ | 📅 2026-08-13 - Open-source simulator for autonomous driving research.
...
* [Facebook Habitat](https://github.com/facebookresearch/habitat-api) ⭐ 3,096 | 🐛 388 | 🌐 Python | 📅 2026-05-07 - A modular high-level library to train embodied AI agents across a variety of tasks, environments, and simulators.
...
* [RLBench](https://github.com/stepjam/RLBench) ⭐ 1,806 | 🐛 94 | 🌐 Python | 📅 2025-01-25 - A large-scale benchmark and learning environment.
* [AI2-THOR](https://github.com/allenai/ai2thor) ⭐ 1,779 | 🐛 279 | 🌐 C# | 📅 2025-11-04 - A near photo-realistic interactable framework for AI agents.
* [OpenAI Neural MMO](https://github.com/openai/neural-mmo) ⚠️ Archived - A Massively Multiagent Game Environment.
* [Microsoft TextWorld](https://github.com/microsoft/TextWorld) ⭐ 1,437 | 🐛 20 | 🌐 Jupyter Notebook | 📅 2026-01-30 - A text-based game generator and extensible sandbox learning environment for training and testing reinforcement learning (RL) agents.
...
* [Microsoft Jericho](https://github.com/microsoft/jericho) ⭐ 332 | 🐛 9 | 🌐 C | 📅 2026-07-31 - A learning environment for man-made Interactive Fiction games.
...
* [mazelab](https://github.com/zuoxingdong/mazelab) ⭐ 271 | 🐛 5 | 🌐 Python | 📅 2019-04-05 - A customizable framework to create maze and gridworld environments.
...
* [OpenAI Spinning Up](https://github.com/openai/spinningup) ⭐ 11,894 | 🐛 254 | 🌐 Python | 📅 2024-08-05
...
* [higgsfield/RL-Adventure-2](https://github.com/higgsfield/RL-Adventure-2) ⭐ 4,063 | 🐛 9 | 🌐 Jupyter Notebook | 📅 2024-05-25
* [higgsfield/RL-Adventure](https://github.com/higgsfield/RL-Adventure) ⭐ 3,178 | 🐛 18 | 🌐 Jupyter Notebook | 📅 2021-11-04
* [PPOxFamily: DRL Tutorial Course](https://github.com/opendilab/PPOxFamily) ⭐ 2,611 | 🐛 56 | 🌐 Python | 📅 2025-03-13
