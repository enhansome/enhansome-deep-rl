...
* [Berkeley Ray RLLib](https://github.com/ray-project/ray) ⭐ 43,608 | 🐛 3,527 | 🌐 Python | 📅 2026-08-25 - An open-source library for reinforcement learning that offers both high scalability and a unified API for a variety of applications.
* [Unity ML-Agents Toolkit](https://github.com/Unity-Technologies/ml-agents) ⭐ 19,644 | 🐛 20 | 🌐 C# | 📅 2026-08-25 - Unity Machine Learning Agents Toolkit.
* [OpenAI Baselines](https://github.com/openai/baselines) ⭐ 16,763 | 🐛 502 | 🌐 Python | 📅 2024-08-01 - High-quality implementations of reinforcement learning algorithms.
* [Tianshou](https://github.com/thu-ml/tianshou/) ⭐ 10,942 | 🐛 137 | 🌐 Python | 📅 2026-04-03 - Tianshou (天授) is a reinforcement learning platform based on pure PyTorch.
* [Google Dopamine](https://github.com/google/dopamine) ⭐ 10,897 | 🐛 111 | 🌐 Jupyter Notebook | 📅 2026-03-24 - A research framework for fast prototyping of reinforcement learning algorithms.
* [DeepMind OpenSpiel](https://github.com/deepmind/open_spiel) ⭐ 5,433 | 🐛 50 | 🌐 C++ | 📅 2026-08-12 - A collection of environments and algorithms for research in general reinforcement learning and search/planning in games.
...
* [DeepMind Acme](https://github.com/deepmind/acme) ⭐ 4,048 | 🐛 100 | 🌐 Python | 📅 2026-08-01 - A research framework for reinforcement learning.
...
* [RLtools](https://github.com/rl-tools/rl-tools) ⭐ 1,026 | 🐛 20 | 🌐 C++ | 📅 2026-07-04 - The fastest deep reinforcement learning library for continuous control, implemented in pure, dependency-free C++ (Python bindings available as well).
* [AgileRL](https://github.com/AgileRL/AgileRL) ⭐ 946 | 🐛 17 | 🌐 Python | 📅 2026-08-25 - A Deep Reinforcement Learning library focused on improving development by introducing RLOps - MLOps for reinforcement learning.
...
* [OpenAI Baselines](https://github.com/openai/baselines#benchmarks) ⭐ 16,763 | 🐛 502 | 🌐 Python | 📅 2024-08-01
...
* [Unity ML-Agents Toolkit](https://github.com/Unity-Technologies/ml-agents) ⭐ 19,644 | 🐛 20 | 🌐 C# | 📅 2026-08-25 - Unity Machine Learning Agents Toolkit.
* [Microsoft AirSim](https://github.com/Microsoft/AirSim) ⭐ 18,418 | 🐛 780 | 🌐 C++ | 📅 2026-06-30 - Open source simulator for autonomous vehicles built on Unreal Engine / Unity, from Microsoft AI & Research.
...
* [Carla](https://github.com/carla-simulator/carla) ⭐ 14,323 | 🐛 1,194 | 🌐 C++ | 📅 2026-08-25 - Open-source simulator for autonomous driving research.
...
* [DouZero](https://github.com/kwai/DouZero/) ⭐ 4,651 | 🐛 35 | 🌐 Python | 📅 2024-06-26 - A research platform for reinforcement learning in DouDizhu (Chinese poker).
...
* [Facebook Habitat](https://github.com/facebookresearch/habitat-api) ⭐ 3,107 | 🐛 388 | 🌐 Python | 📅 2026-05-07 - A modular high-level library to train embodied AI agents across a variety of tasks, environments, and simulators.
...
* [RLBench](https://github.com/stepjam/RLBench) ⭐ 1,812 | 🐛 94 | 🌐 Python | 📅 2025-01-25 - A large-scale benchmark and learning environment.
...
* [OpenAI Procgen Benchmark](https://github.com/openai/procgen) ⭐ 1,184 | 🐛 20 | 🌐 C++ | 📅 2026-03-27 - Procedurally Generated Game-Like Gym Environments.
...
* [Stanford osim-rl](https://github.com/stanfordnmbl/osim-rl) ⭐ 944 | 🐛 37 | 🌐 Python | 📅 2022-01-24 - Reinforcement learning environments with musculoskeletal models.
...
* [OpenAI Spinning Up](https://github.com/openai/spinningup) ⭐ 11,913 | 🐛 253 | 🌐 Python | 📅 2024-08-05
...
* [The Hugging Face Deep Reinforcement Learning Class 🤗](https://github.com/huggingface/deep-rl-class#the-hugging-face-deep-reinforcement-learning-class-) ⭐ 4,994 | 🐛 145 | 🌐 MDX | 📅 2026-05-26
* [higgsfield/RL-Adventure-2](https://github.com/higgsfield/RL-Adventure-2) ⭐ 4,099 | 🐛 9 | 🌐 Jupyter Notebook | 📅 2024-05-25
